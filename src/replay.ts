...
import type { RelayDetails, RelayRenderState } from "./pi-relay.js";
import { manageElapsedTimer, renderRelayResult } from "./pi-relay.js";
...
export const registerReplayTool = (
	...
	pi.registerTool<typeof ReplayParamsSchema, RelayDetails, RelayRenderState>({
		...
		async execute(_toolCallId, params, signal, onUpdate, ctx) {
			...
			const fullActorDiscovery = discoverActors(ctx.cwd, "user", {
				bundledDir: bundled.actorsDir,
			});
			const actorDiscovery = {
				...fullActorDiscovery,
				actors: filterActors(fullActorDiscovery.actors, config),
			};
